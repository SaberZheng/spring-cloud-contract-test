 ...
 */
package com.ecut.generated.tables.records;
...
public class AuthorRecord extends UpdatableRecordImpl<AuthorRecord> implements Record4<Integer, String, String, Boolean> {
    ...
    private static final long serialVersionUID = -785287828;
    ...
    /**
     * Setter for <code>library.author.deleted</code>.
     */
    ...
    /**
     * Getter for <code>library.author.deleted</code>.
     */
     ...
     */
    public AuthorRecord(Integer id, String lastName, String firstName, Boolean deleted) {
        super(Author.AUTHOR);
